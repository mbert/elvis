...
!MESSAGE 
!MESSAGE NMAKE /f "ctags.mak" CFG="Win32 Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /I "oswin32" /I "." /D "WIN32" /D "NDEBUG"\
 /D "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ctags.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ctags.bsc" 
BSC32_SBRS= \
	$(INTDIR)/"ctags.sbr"

$(OUTDIR)/"ctags.bsc" : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /I "oswin32" /I "." /D "WIN32" /D\
 "_DEBUG" /D "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ctags.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ctags.pdb" /c 
CPP_OBJS=.\WinDebug/
...
$(INTDIR)/"ctags.obj" :  $(SOURCE)  $(INTDIR)
