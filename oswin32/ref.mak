...
!MESSAGE 
!MESSAGE NMAKE /f "ref.mak" CFG="Win32 Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /I "oswin32" /I "." /D "WIN32" /D "NDEBUG"\
 /D "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ref.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ref.bsc" 
BSC32_SBRS= \
	$(INTDIR)/"ref.sbr"

$(OUTDIR)/"ref.bsc" : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /I "oswin32" /I "." /D "WIN32" /D\
 "_DEBUG" /D "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ref.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ref.pdb" /c 
CPP_OBJS=.\WinDebug/
