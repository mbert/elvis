...
#define VERSION "ELVIS 1.8pl4, by Steve Kirkendall (27 June 1994)"
...
extern char	o_controlz[1];
#endif

#if OS2
extern char	o_viomode[1];
#endif
...
extern void	msg P_((char *, ...));		/* writes a printf-style message to the screen */
...
extern char	*get_cursor_word P_((MARK));		/* returns word at cursor */
...
extern int	doexcmd P_((char *, int));
...
#endif
extern void	cmd_comment P_((MARK, MARK, CMD, int, char *));
...
#ifndef NO_IF
extern void	cmd_if P_((MARK, MARK, CMD, int, char *));
#endif
...
#ifndef NO_IF
extern void	cmd_then P_((MARK, MARK, CMD, int, char *));
#endif
